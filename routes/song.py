...
cloudinary.config( 
    cloud_name = "dbckbxbk3", 
    api_key = "617276973644888", 
    api_secret = "RyO_MvTRnbb6yZagoAvdDpDs4uw", 
    secure=True
)
